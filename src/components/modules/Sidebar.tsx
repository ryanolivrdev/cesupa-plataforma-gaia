            ...
            <li>
              <CollapsiblePrimitive.Root>
                <CollapsiblePrimitive.Trigger
                  className={clsx(
                    "flex w-full items-center rounded-lg p-2 transition duration-75 hover:bg-green-300",
                    {
                      "bg-green-400": router.pathname.includes("/registration"),
                    }
                  )}
                >
                  <UsersIcon className="h-6 w-6" />
                  <Text className="ml-3 font-bold">Cadastro</Text>
                ...
                <CollapsiblePrimitive.Content>
                  <ul className="ml-4 space-y-2 py-2">
                    <li>
                      <Link
                        href="/registration/resident"
                        onClick={() => toggleSidebar()}
                        className={clsx(
                          "flex items-center rounded-lg p-2 transition duration-75 hover:bg-green-300",
                          {
                            "bg-green-400":
                              router.pathname === "/registration/resident",
                          }
                        )}
                      >
                        <UserPlusIcon className="h-6 w-6" />
                        <Text className="ml-3 font-bold">Morador</Text>
                      </Link>
                    </li>
                    <li>
                      <Link
                        href="/registration/dentalAnamnesis"
                        onClick={() => toggleSidebar()}
                        className={clsx(
                          "flex items-center rounded-lg p-2 transition duration-75 hover:bg-green-300",
                          {
                    ...
                    <li>
                      <Link
                        href="/registration/psychologicalAnamnesis"
                        onClick={() => toggleSidebar()}
                        className={clsx(
                          "flex items-center rounded-lg p-2 transition duration-75 hover:bg-green-300",
                          {
                            "bg-green-400":
                              router.pathname ===
                              "/registration/psychologicalAnamnesis",
                          }
                        )}
                      >
                        <BookmarkIcon className="h-6 w-6" />
                    ...
                    <li>
                      <Link
                        href="/registration/medicalAnamnesis"
                        onClick={() => toggleSidebar()}
                        className={clsx(
                          "flex items-center rounded-lg p-2 transition duration-75 hover:bg-green-300",
                          {
                            "bg-green-400":
                              router.pathname ===
                              "/registration/medicalAnamnesis",
                          }
                        )}
                      >
                        <BookmarkIcon className="h-6 w-6" />
                        <Text className="ml-3 font-bold">Anamnese Médica</Text>
                      </Link>
                    </li>
                    <li>
                      <Link
                        href="/registration/consultaMedica"
                        onClick={() => toggleSidebar()}
                        className={clsx(
                          "flex items-center rounded-lg p-2 transition duration-75 hover:bg-green-300",
                          {
                            "bg-green-400":
                              router.pathname ===
                              "/registration/consultaMedica",
                          }
                        )}
                      >
                        <BookmarkIcon className="h-6 w-6" />
                        <Text className="ml-3 font-bold">Consulta Medica</Text>
                      </Link>
                    </li>
                    <li>
                      <Link
                        href="/registration/triagemNutricional"
                        onClick={() => toggleSidebar()}
                        className={clsx(
                          "flex items-center rounded-lg p-2 transition duration-75 hover:bg-green-300",
                          {
                            "bg-green-400":
                              router.pathname ===
                              "/registration/triagemNutricional",
                          }
                        )}
                      >
                        <BookmarkIcon className="h-6 w-6" />
                    ...
                    <li>
                      <Link
                        href="/registration/physiotherapyAnamnesis"
                        onClick={() => toggleSidebar()}
                        className={clsx(
                          "flex items-center rounded-lg p-2 transition duration-75 hover:bg-green-300",
                          {
                            "bg-green-400":
                              router.pathname ===
                              "/registration/physiotherapyAnamnesis",
                          }
                        )}
                      >
                        <BookmarkIcon className="h-6 w-6" />
                        <Text className="ml-3 font-bold">
                          Anamnese Fisoterapia
                        </Text>
                      </Link>
                    </li>
                    <li>
                      <Link
                        href="/registration/documentsEmission"
                        onClick={() => toggleSidebar()}
                        className={clsx(
                          "flex items-center rounded-lg p-2 transition duration-75 hover:bg-green-300",
                          {
                            "bg-green-400":
                              router.pathname ===
                              "/registration/documentsEmission",
                          }
                        )}
                      >
                        <BookmarkIcon className="h-6 w-6" />
                    ...
                    <li>
                      <Link
                        href="/registration/entrepreneurship"
                        onClick={() => toggleSidebar()}
                        className={clsx(
                          "flex items-center rounded-lg p-2 transition duration-75 hover:bg-green-300",
                          {
                            "bg-green-400":
                              router.pathname ===
                              "/registration/entrepreneurship",
                          }
                        )}
                      >
                        <BookmarkIcon className="h-6 w-6" />
                        <Text className="ml-3 font-bold">Empreendedorismo</Text>
                      </Link>
                    </li>
                  </ul>
                </CollapsiblePrimitive.Content>
